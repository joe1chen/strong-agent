...
exports.cpuutil = function (onMetric)
{
  ...
  function fixNegativeValues(percent_proc, percent_user, percent_syst) {
    ...
    if ((typeof percent_proc !== 'number') || (percent_proc < 0)) { percent_proc = 0; }
    if ((typeof percent_user !== 'number') || (percent_user < 0)) { percent_user = 0; }
    if ((typeof percent_syst !== 'number') || (percent_syst < 0)) { percent_syst = 0; }
					...
					stdout.split('\n').forEach(function(item){
						...
						if(pid === process.pid){
							...
							if(uptime_delta>0){
								...
								fixNegativeValues(usage*100,usage*100,0);
							}
